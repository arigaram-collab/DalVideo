...
public static class Strings
{
    ...
    public static string PreviewLabel => GetString(nameof(PreviewLabel));
    ...
    public static string Tooltip_Preview => GetString(nameof(Tooltip_Preview));
    ...
    public static string Access_Preview => GetString(nameof(Access_Preview));
